        ...
        for message_block in blocks:
            ...
            for t in range(0, 64):
                if t <= 15:
                    ...
                    term1 = self._sigma1(int.from_bytes(
                        message_schedule[t-2], 'big'))
                    term2 = int.from_bytes(message_schedule[t-7], 'big')
                    term3 = self._sigma0(int.from_bytes(
                        message_schedule[t-15], 'big'))
            ...
            for t in range(64):
                t1 = ((h + self._capsigma1(e) + self._ch(e, f, g) + K[t] +
